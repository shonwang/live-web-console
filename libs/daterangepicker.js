...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            var tempLeft = parseInt(this.parentEl.css("left").split("px")[0]);

            if (this.opens == 'left') {
                this.container.css({
                    top: this.element.offset().top + this.element.outerHeight() - parentOffset.top,
                    right: $(window).width() - this.element.offset().left - this.element.outerWidth() - parentOffset.left + tempLeft - 10,
                    left: 'auto'
                });
